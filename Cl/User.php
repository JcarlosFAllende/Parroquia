...
class Cl_User
{
	...
	public function registration( array $data )
	{
		if( !empty( $data ) ){
			...
			echo '<script language="javascript">alert("SI ENTRAMOS");</script>';
			...
			$query = "INSERT INTO `usuarios` (`idUsuario`, `Nombre`, `Correo`, `Password`) VALUES (NULL, '$name', '$email', '$password')";
			//, CURRENT_TIMESTAMP
	...
	public function login( array $data )
	{
		...
		if( !empty( $data ) ){
			...
			//$password = md5( $password );
			$query = "SELECT idUsuario, Nombre, Correo FROM usuarios where correo = '$email' and password = '$password' ";
	...
	public function forgetPassword( array $data )
	{
		if( !empty( $data ) ){
			...
			if(mysqli_query($this->_con, $query)){
				...
				$headers = "From: carlitosallende99@gmail.com" . "\r\n" .
						"CC: carlitosallende99@gmail.com";
